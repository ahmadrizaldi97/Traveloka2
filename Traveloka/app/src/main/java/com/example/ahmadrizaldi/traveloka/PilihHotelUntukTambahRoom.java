...
public class PilihHotelUntukTambahRoom extends AppCompatActivity {

    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private ArrayList<Hotel> hotelArrayList = new ArrayList<>();
    private AdapterPilihHotel mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pilih_hotel_untuk_tambah_room);

        recyclerView = (RecyclerView)findViewById(R.id.pilihHotelRecyc);
        recyclerView.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

        mAdapter = new AdapterPilihHotel(PilihHotelUntukTambahRoom.this, hotelArrayList);
