...
public class InsertData2 extends AppCompatActivity {
    ...
    private EditText namaPenumpang,namaPenumpang2;
    private int hargaku;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namaPenumpang = (EditText)findViewById(R.id.nama2Penumpang);
        namaPenumpang2 = (EditText)findViewById(R.id.nama2Penumpang2);
        gambarLogo = (ImageView)findViewById(R.id.imageView2);
        maskapaiNama = (TextView)findViewById(R.id.textView5);

        penumpang_lengkap = namaPenumpang.getText().toString();

        final StringBuilder buffer = new StringBuilder().append(namaPenumpang.getText().toString())
                .append(",").append(namaPenumpang2.getText().toString());
        ...
        ubahdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ubahdata = new Intent(InsertData2.this, DataPemesan.class);
        ...
        lanjut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent oo = new Intent(InsertData2.this, Review_.class);
                Bundle b = new Bundle();
                ...
                b.putString("namaPenumpang", namaPenumpang.getText().toString() + "." + namaPenumpang2.getText().toString());
                b.putString("hargaku", String.valueOf(hargaku));
                oo.putExtras(b);

                startActivityForResult(oo, 404);
//                System.out.println(penumpang_lengkap + " ---d---------d-d--d-d-");
