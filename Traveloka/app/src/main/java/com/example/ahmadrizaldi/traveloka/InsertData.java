...
public class InsertData extends AppCompatActivity {
    ...
    private EditText namaPenumpang;
    private int hargaku;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namaPenumpang = (EditText)findViewById(R.id.namaPenumpang);
        ...
        ubahdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ubahdata = new Intent(InsertData.this, DataPemesan.class);
        ...
        lanjut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent oo = new Intent(InsertData.this, Review_.class);
                Bundle b = new Bundle();
                ...
                b.putString("namaPenumpang", namaPenumpang.getText().toString().trim());
