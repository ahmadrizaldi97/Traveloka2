...
/**
 * Created by ahmadrizaldi on 12/31/17.
 */

public class AdapterPilihHotel extends RecyclerView.Adapter<AdapterPilihHotel.ViewHolder> {

    private Context context;
    private ArrayList<Hotel> rvData;

    public AdapterPilihHotel() {
    }

    public AdapterPilihHotel(Context context, ArrayList<Hotel> rvData) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.namaHotel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context, TambahRoomHotel.class);
                Bundle b = new Bundle();
